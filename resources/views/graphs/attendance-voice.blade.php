    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Oppmøte etter stemme</div>

                <div class="panel-body">
                    <form class="form-horizontal form-inline margin-bottom-fix" role="form" name="add_form" method="GET" action="{{ url('/graphs/attendance-by-voice') }}">
                        ...
                        <div class="form-group">
                            ...
                            <label for="show_inactive">Inkluder inaktive medlemmer</label>
                        </div>
