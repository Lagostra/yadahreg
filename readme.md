⚠️ **WARNING**: This is the legacy version of YadahReg, written in PHP. For the new version written in React with a Firebase backend, check out the `v2.0` branch.
